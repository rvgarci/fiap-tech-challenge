...
def get_processing_data(option: str, suboption: Optional[str], year: int) -> List[schema.ProcessingItem]:
    """Faz scraping da aba de Processamento da Embrapa e retorna os dados como lista de ProcessingItem."""
    return fetch_table_data(option, suboption, year, schema.ProcessingItem)

def get_commercial_data(option: str, suboption: Optional[str], year: int) -> List[schema.CommercialItem]:
    """Faz scraping da aba de Comercialização da Embrapa e retorna os dados como lista de CommercialItem."""
    return fetch_table_data(option, suboption, year, schema.CommercialItem)

def get_import_data(option: str, suboption: Optional[str], year: int) -> List[schema.ImportItem]:
    """Faz scraping da aba de Importação da Embrapa e retorna os dados como lista de ImportItem."""
    return fetch_table_data(option, suboption, year, schema.ImportItem)

def get_export_data(option: str, suboption: Optional[str], year: int) -> List[schema.ExportItem]:
    """Faz scraping da aba de Exportação da Embrapa e retorna os dados como lista de ExportItem."""
